...
const BullSpread = (props) => {
    ...
    const clickHandler = () => {
        const reqbody = {
            ...
            callBuyStrikePrice: selectedStrike,
            callSellStrikePrice: selectedPutStrike,
    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '15px', flexWrap: 'wrap', marginTop: '10px' }}>
                ...
                <Autocomplete data={strikePrice} change={(e) => setStrike(e)} value={selectedStrike} style={{ width: '180px' }} callBuy={true} />
                <Autocomplete data={strikePrice} change={(e) => setPutStrike(e)} value={selectedPutStrike} style={{ width: '180px' }} callSell={true} />
