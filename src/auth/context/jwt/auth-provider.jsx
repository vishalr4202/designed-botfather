...
const { acgSlice: state } = useSelector(acgStateSelector);
  ...
  const checkAuthenticated = state?.loginData?.isLoggedIn ? 'authenticated' : 'unauthenticated';

  const status = state?.loginData?.isLoggedIn == false ? 'loading' : checkAuthenticated;
