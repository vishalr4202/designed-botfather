    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '15px', flexWrap: 'wrap', marginTop: '10px' }}>
                ...
                <Autocomplete data={strikePrice} change={(e) => setStrike(e)} value={selectedStrike} style={{ width: '180px' }} callPrice={true} />
                <Autocomplete data={strikePrice} change={(e) => setPutStrike(e)} value={selectedPutStrike} style={{ width: '180px' }} putPrice={true} />
                ...
                <Autocomplete data={['50', '100', '150', '200', '250', '300', '350', '400', '450', '500']} change={(e) => setHedgeValue(e)} value={hedge} style={{ width: '180px' }} hedge={true} />
            </div>
